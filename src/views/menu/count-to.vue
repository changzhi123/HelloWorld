<template>
  <div class="components-container">
    <count-to
      ...
      :suffix="_suffix"
      :autoplay="false"
      class="example" :style="`color:${color};`"
    />
    <div style="margin-left: 25%;margin-top: 40px;">
      <label class="label" for="startValInput">开始于:
        <input v-model.number="setStartVal" type="number" name="startValInput">
      </label>
      <label class="label" for="endValInput">结束于:
      ...
      <label class="label" for="separatorInput">分离器:
