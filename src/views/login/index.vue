<template>
  ...
  <div class="login">
    ...
    <div class="login-box">
      ...
      <div class="imput-box">
        <a-input size="large" :maxlength="30" placeholder="请输入账号" allowClear @change="canonical('username')" 
      ...
      <div class="imput-box">
        <a-input-password size="large" :maxlength="18" allowClear placeholder="请输入密码"
         @change="canonical('password')" v-model:value="state.formData.password" @pressEnter="login()">
          <template #prefix>
            <LockOutlined />
          </template>
        </a-input-password>
      ...
      <a-button type="primary" size="large" @click="login()" block :loading="state.loading">登录</a-button>
